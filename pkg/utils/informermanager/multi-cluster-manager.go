...
func NewMultiClusterInformerManager(stopCh <-chan struct{},
...
func (m *multiClusterInformerManagerImpl) ForCluster(
	cluster string, client kubernetes.Interface,
...
func (m *multiClusterInformerManagerImpl) WaitForCacheSyncWithTimeout(
	cluster string, cacheSyncTimeout time.Duration,
