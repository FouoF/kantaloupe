...
func (c *clusterConditionStore) thresholdAdjustedReadyCondition(
	...
	curReadyCondition := meta.FindStatusCondition(cluster.Status.Conditions, clustercrdv1alpha1.ClusterConditionReady)
